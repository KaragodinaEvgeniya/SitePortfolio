function ready(){  
    ...
    var navTrigger = document.getElementById('hamburger');
var nav = document.getElementById('nav');
var header = document.getElementById('header');
var heading = document.getElementById('heading');
var labels = document.getElementsByClassName('nav-label__elem');
...
function navToggle(e) {
  ...
  if(closed) {
    navTrigger.className = 'hamburger open';
    nav.className = 'out';
  } else {
    navTrigger.className = 'hamburger close';
    nav.className = 'in';
  }
}
